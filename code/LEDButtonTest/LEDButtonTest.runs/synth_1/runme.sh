...
HD_PWD='/home/runge/Subjects/Embedded/code/LEDButtonTest/LEDButtonTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log On_Off.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source On_Off.tcl
