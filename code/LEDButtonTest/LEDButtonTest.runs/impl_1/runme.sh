...
HD_PWD='/home/runge/Subjects/Embedded/code/LEDButtonTest/LEDButtonTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log On_Off.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source On_Off.tcl -notrace
