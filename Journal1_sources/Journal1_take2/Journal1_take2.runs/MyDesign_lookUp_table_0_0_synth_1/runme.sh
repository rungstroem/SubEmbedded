...
HD_PWD='/home/runge/Subjects/Embedded/Journal1_sources/Journal1_take2/Journal1_take2.runs/MyDesign_lookUp_table_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyDesign_lookUp_table_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyDesign_lookUp_table_0_0.tcl
