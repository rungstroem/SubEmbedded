...
HD_PWD='/home/runge/Subjects/Embedded/Journal1_sources/Journal1/Journal1.runs/TopLevel_clock_scaler1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_clock_scaler1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_clock_scaler1_0_0.tcl
