...
HD_PWD='/home/runge/Subjects/Embedded/Journal1_sources/Journal1/Journal1.runs/TopLevel_multiplexer_4x1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_multiplexer_4x1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_multiplexer_4x1_0_0.tcl
