...
HD_PWD='/home/runge/PWM_LED_BLINK/PWM_LED_BLINK.runs/design_1_comparator_27bits_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_comparator_27bits_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_comparator_27bits_0_0.tcl
