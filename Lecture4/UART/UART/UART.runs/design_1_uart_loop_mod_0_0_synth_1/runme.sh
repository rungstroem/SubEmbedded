...
HD_PWD='/home/runge/Subjects/Embedded/Lecture4/UART/UART/UART.runs/design_1_uart_loop_mod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_uart_loop_mod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_uart_loop_mod_0_0.tcl
