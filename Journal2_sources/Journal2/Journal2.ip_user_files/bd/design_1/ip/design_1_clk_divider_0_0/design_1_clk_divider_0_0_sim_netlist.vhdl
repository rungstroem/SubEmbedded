...
-- Date        : Sun Oct 11 13:09:14 2020
-- Host        : E7440-big-ARCH running 64-bit unknown
-- Command     : write_vhdl -force -mode funcsim
--               /home/runge/Subjects/Embedded/Journal2_sources/Journal2/Journal2.srcs/sources_1/bd/design_1/ip/design_1_clk_divider_0_0/design_1_clk_divider_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_clk_divider_0_0_clk_divider is
  ...
  signal \count_sig_reg__0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \count_sig[5]_i_2\ : label is "soft_lutpair0";
...
clk_div_sig_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \count_sig_reg__0\(2),
      I3 => \count_sig_reg__0\(3),
...
clk_div_sig_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
        ...
        port map (
      I0 => \count_sig_reg__0\(7),
      I1 => \count_sig_reg__0\(6),
      I2 => \count_sig_reg__0\(4),
      I3 => \count_sig_reg__0\(5),
...
clk_div_sig_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => \count_sig_reg__0\(0),
      I1 => \count_sig_reg__0\(1),
...
\count_sig[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \count_sig_reg__0\(2),
      I2 => \count_sig_reg__0\(3),
      I3 => \count_sig_reg__0\(0),
      I4 => \count_sig_reg__0\(1),
      O => p_0_in(1)
    );
\count_sig[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
        ...
        port map (
      I0 => \count_sig_reg__0\(2),
      I1 => \count_sig_reg__0\(0),
      I2 => \count_sig_reg__0\(1),
      O => p_0_in(2)
    );
\count_sig[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6CCC"
        ...
        port map (
      I0 => \count_sig_reg__0\(2),
      I1 => \count_sig_reg__0\(3),
      I2 => \count_sig_reg__0\(0),
      I3 => \count_sig_reg__0\(1),
      O => p_0_in(3)
    );
\count_sig[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFB7FFF80008000"
        ...
        port map (
      I0 => \count_sig_reg__0\(1),
      I1 => \count_sig_reg__0\(0),
      I2 => \count_sig_reg__0\(2),
      I3 => \count_sig_reg__0\(3),
      I4 => clk_div_sig_i_2_n_0,
      I5 => \count_sig_reg__0\(4),
      O => p_0_in(4)
    );
\count_sig[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \count_sig_reg__0\(7),
      I3 => \count_sig_reg__0\(6),
      I4 => \count_sig_reg__0\(4),
      I5 => \count_sig_reg__0\(5),
      O => p_0_in(5)
    );
...
\count_sig[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \count_sig[6]_i_2_n_0\,
      I2 => \count_sig_reg__0\(7),
      I3 => \count_sig_reg__0\(4),
      I4 => \count_sig_reg__0\(5),
      I5 => \count_sig_reg__0\(6),
      O => p_0_in(6)
    );
...
entity design_1_clk_divider_0_0 is
  ...
  attribute x_core_info of design_1_clk_divider_0_0 : entity is "clk_divider,Vivado 2018.3";
