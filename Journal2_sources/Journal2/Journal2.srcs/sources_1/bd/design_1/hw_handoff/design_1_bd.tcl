...
# module references:
# RAM16x8, RAMController, clk_divider, rx_mod, tx_mod
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports clk_0] [get_bd_pins RAM16x8_0/clk] [get_bd_pins clk_divider_0/clk] [get_bd_pins tx_mod_0/clkfast]
  connect_bd_net -net RAM16x8_0_dout [get_bd_pins RAM16x8_0/dout] [get_bd_pins RAMController_0/dOut_RAM]
  connect_bd_net -net RAMController_0_addr [get_bd_pins RAM16x8_0/addr] [get_bd_pins RAMController_0/addr]
  connect_bd_net -net RAMController_0_dIn_RAM [get_bd_pins RAM16x8_0/din] [get_bd_pins RAMController_0/dIn_RAM]
  connect_bd_net -net RAMController_0_dIn_UART [get_bd_pins RAMController_0/dIn_UART] [get_bd_pins tx_mod_0/data_in]
  connect_bd_net -net RAMController_0_shift_load [get_bd_pins RAMController_0/shift_load] [get_bd_pins tx_mod_0/shift_load]
  connect_bd_net -net RW_0_1 [get_bd_ports RW_0] [get_bd_pins RAM16x8_0/wr] [get_bd_pins RAMController_0/RW]
  connect_bd_net -net clk_divider_0_clk_div [get_bd_pins RAMController_0/clk] [get_bd_pins clk_divider_0/clk_div] [get_bd_pins rx_mod_0/clk]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins RAMController_0/rst] [get_bd_pins clk_divider_0/rst] [get_bd_pins rx_mod_0/rst] [get_bd_pins tx_mod_0/rst]
  connect_bd_net -net rx_mod_0_data_out [get_bd_pins RAMController_0/dOut_UART] [get_bd_pins rx_mod_0/data_out]
  connect_bd_net -net rx_mod_0_intr [get_bd_pins RAMController_0/intr] [get_bd_pins rx_mod_0/intr]
  ...
  connect_bd_net -net tx_mod_0_xmitmt [get_bd_pins RAMController_0/xmint] [get_bd_pins tx_mod_0/xmitmt]
