...
HD_PWD='/home/runge/Subjects/Embedded/Journal2_sources/Journal2/Journal2.runs/design_1_tx_mod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_tx_mod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_tx_mod_0_0.tcl
